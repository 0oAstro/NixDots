{
  ...
  config = ''
    ...
    riverctl map normal Menu spawn 'wofi'
    ...
    do
        ...
        riverctl map $mode None XF86AudioMute         spawn 'pamixer --mute'
    ...
    riverctl background-color ${x0Colors.base00}
    riverctl border-color-focused ${x0Colors.base0D}
    riverctl border-color-unfocused ${x0Colors.base02}
    ...
    rivertile -view-padding 14 -outer-padding 12

    riverctl spawn '\${pkgs.swaybg}/bin/swaybg -i ~/.config/wallpaper.png'
    riverctl spawn 'mako'
    riverctl spawm 'systemctl --user import-environment; systemctl --user start graphical-session.target'
  '';
in
  config
